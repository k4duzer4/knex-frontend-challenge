...
function UpsertTestimonialModal({
  ...
  useEffect(() => {
    ...
    setSubmitError('')
  }, [initialMessage, initialName, initialRole, isOpen])
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setSubmitError(error instanceof Error ? error.message : 'Nao foi possivel salvar o depoimento agora.')
    }
  }
    ...
    <div className="home-testimonials-modal__backdrop" role="presentation" onClick={onClose}>
      ...
      >
        <form className="home-testimonials-modal__form" onSubmit={handleSubmit}>
          ...
          <label htmlFor="testimonial-name" className="home-testimonials-modal__label">Nome</label>
          <input
            id="testimonial-name"
          ...
          <label htmlFor="testimonial-role" className="home-testimonials-modal__label">Cargo</label>
          <input
            id="testimonial-role"
            className="home-testimonials-modal__input"
            type="text"
          ...
          <label htmlFor="testimonial-message" className="home-testimonials-modal__label">Depoimento</label>
          <textarea
          ...
          <div className="home-testimonials-modal__actions">
            <button type="button" className="home-testimonials-modal__button home-testimonials-modal__button--cancel" onClick={onClose}>
              Cancelar
            </button>
            <button type="submit" className="home-testimonials-modal__button home-testimonials-modal__button--confirm">
